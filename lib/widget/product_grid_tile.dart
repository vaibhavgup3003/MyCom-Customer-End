              ...
              builder: (context, favouriteProvider, child) {
                return IconButton(
                  icon: Icon(
                    Icons.favorite,
                    //make color dynamic
                    color: favouriteProvider.checkIsItemFavourite(product.sId??'')?Colors.red : const Color(0xFFA6A3A0),
                  ),
                  onPressed: () {
                    //complete make call updateToFavouriteList
                    context.favouriteProvider.updateToFavouriteList(product.sId ?? '');
                  },
                );
              },
            ),
