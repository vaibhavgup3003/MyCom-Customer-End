                  ...
                  child: Consumer<CartProvider>(
                    builder: (context, cartProvider, child) {
                      return Column(
                        ...
                        children: [
                           Text('Total Amount             : \$${context.cartProvider.getCartSubTotal()}', // complete to CartSubTotal
                              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black)),
                          Text('Total Offer Applied  : \$${cartProvider.couponCodeDiscount}',
                              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black)),
                           Text('Grand Total            : \$${context.cartProvider.getGrandTotal()}', // complete to GrandTotal
                ...
                Consumer<CartProvider>(
                  builder: (context, cartProvider, child) {
                    return CompleteOrderButton(
                        labelText: 'Complete Order  \$${context.cartProvider.getGrandTotal()} ', // complete to GrandTotal
                        onPressed: () {
